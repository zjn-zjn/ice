...
//
//    public static boolean isRelation(IceEditNode dto) {
...
//    @Override
//    @Transactional
//    public EditResult editConf(Integer app, Integer type, Long iceId, IceEditNode confVo) {
...
////                    }
//                } else {
//                    IceConf operateConf = iceServerService.getMixConfById(app, confVo.getSelectId(), iceId);
//                    if (operateConf != null) {
...
//                            return result;
//                        }
//                        if (confVo.getMultiplexIds() != null) {
//                            /*从已知节点ID添加*/
//                            String[] sonIdStrs = confVo.getMultiplexIds().split(",");
...
//                                result.setCode(-1);
//                                result.setMsg("one of son id not exist:" + confVo.getMultiplexIds());
//                                return result;
//                            }
//                            operateConf.setSonIds(StringUtils.isEmpty(operateConf.getSonIds()) ?
//                                    String.valueOf(confVo.getMultiplexIds()) :
//                                    operateConf.getSonIds() + "," + confVo.getMultiplexIds());
...
//                                Integer index = confVo.getIndex();
//                                if (index == null || index < 0 || index >= sonIdStrs.length || !sonIdStrs[index].equals(confVo.getSelectId() + "")) {
...
//                                result.setUnLinkId(confVo.getSelectId());
//                                operateConf.setUpdateAt(new Date());
//                                if (!operateConf.isUpdate()) {
//                                    operateConf.setIceId(iceId);
//                                    operateConf.setConfId(operateConf.getId());
...
//                        if (operateConf != null) {
//                            /*多校验一步*/
//                            if (operateConf.getForwardId() != null && operateConf.getForwardId().equals(confVo.getSelectId())) {
...
//                        if (confVo.getMultiplexIds() != null) {
//                            /*从已知节点ID添加*/
//                            Long forwardId = Long.valueOf(confVo.getMultiplexIds());
...
//                            if (forward == null) {
//                                result.setCode(-1);
//                                result.setMsg("id not exist:" + confVo.getMultiplexIds());
//                                return result;
//                            }
...
//                                List<IceConf> children = iceServerService.getMixConfListByIds(app, sonIdSet, iceId);
//                                if (CollectionUtils.isEmpty(children) || children.size() != sonIdSet.size()) {
//                                    throw new ErrorCodeException(ErrorCode.ID_NOT_EXIST, "sonIds", confVo.getMultiplexIds());
//                                }
//                                if (iceServerService.haveCircle(confVo.getParentId(), sonIdSet)) {
//                                    result.setCode(-1);
//                                    result.setMsg("have circle");
//                                    return result;
//                                }
...
//                                StringBuilder sb = new StringBuilder();
//                                Integer index = confVo.getIndex();
//                                if (index == null || index < 0 || index >= sonIds.length || !sonIds[index].equals(confVo.getSelectId() + "")) {
//                                    throw new ErrorCodeException(ErrorCode.INPUT_ERROR, "parent do not have this son with input index");
//                                }
//                                sonIds[index] = confVo.getMultiplexIds();
...
//                                    return result;
//                                }
//                                Long exchangeForwardId = Long.parseLong(confVo.getMultiplexIds());
