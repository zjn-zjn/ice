...
class ScoreFlow:
    ...
    def do_flow(self, roam: Roam) -> bool:
        return roam.get("score", 0) >= self.threshold
...
class TestLeafExecution(unittest.TestCase):
    ...
    def test_result_leaf(self):
        ...
        result = node.process(roam)
        self.assertEqual(result, RunState.TRUE)
        self.assertEqual(roam.get("amount"), 200.0)
    ...
    def test_none_leaf(self):
        ...
        self.assertEqual(roam.get("logged"), "hello")
...
class TestManualRegistration(unittest.TestCase):
    ...
    def test_register_leaf(self):
        ...
        class CustomLeaf:
            ...
            def do_flow(self, roam: Roam) -> bool:
                return roam.get("x", 0) > self.value
