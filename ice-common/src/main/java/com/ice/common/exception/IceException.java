...
public class IceException extends RuntimeException {
    private static final long serialVersionUID = -1134557920203105120L;
     ...
     * @since 1.7
     */
    public IceException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
